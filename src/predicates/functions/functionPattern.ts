import { FunctionPatternEnum, FunctionPatternOper } from './enums';
 ...
 * @param oper The pattern operation to perform (e.g. 'name_matches').
 ...
 * const pattern = /^foo/;
 *
 * functionPattern(fn, 'name_matches', pattern); // true
 */
